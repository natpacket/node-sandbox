...
globalMy.window_matchMedia = function () {
    ...
    var true_track = [
        '(any-pointer: fine )', '(any-pointer )', '(any-hover: hover )', '(any-hover )', '(color-gamut: srgb )', '(color-gamut )'
    ]
    globalMy.value[name] = {
        matches: false,
        media: arguments[0] + '',
...
globalMy.RTCPeerConnection.prototype = wanfeng.RTCPeerConnection.prototype;
...
globalMy["Image"].prototype = wanfeng["Image"].prototype;
...
globalMy["XMLHttpRequest"].prototype = wanfeng["XMLHttpRequest"].prototype;
...
globalMy["WebSocket"].prototype = wanfeng["WebSocket"].prototype;
...
globalMy.Promise.prototype = wanfeng.Promise.prototype;
/*
